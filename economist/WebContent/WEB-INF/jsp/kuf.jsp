	...
	<table class="table table-striped table-bordered">
		<thead class="thead-light">
			<tr>
				...
				<th class="text-center" scope="col">Naziv dobavljaca i sjediste</th>
				<th class="text-center" scope="col">Identifikacioni br. dobavljaca</th>
				<th class="text-center" scope="col">Iznos fakture</th>
				<th class="text-center" scope="col">Ukupan iznos sa PDV</th>
				<th class="text-center" scope="col">Ukupan iznos ulaznog poreza</th>
				<th class="text-center" scope="col">Ulazni porez koji se moze odbiti</th>
			</tr>
		</thead>
		<tbody>
