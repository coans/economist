...
<div class="container">
	...
	<p>&nbsp;</p>					
	<table class="${tableClass}" id="kufTable">
		<thead class="thead-light">
			<tr>
				...
				<th class="text-center" style="width:15%" scope="col"><spring:message code="kuf.ukupno"/></th>
				<th class="text-center" style="width:15%" scope="col"><spring:message code="iznos"/></th>
				<th class="text-center" style="width:15%" scope="col"><spring:message code="kuf.pdv"/></th>
			</tr>
		</thead>
		<tbody>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		setPaginationTableLabels('#kufTable');
	});
</script>
